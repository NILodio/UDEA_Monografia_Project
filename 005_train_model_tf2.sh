...
echo "Did you update the paths pretrained.config?"
...
# python model_main_tf2.py --model_dir=models\mono_ssd_mobilenet_v2_fplite --pipeline_config_path=models\mono_ssd_mobilenet_v2_fplite\pipeline.config